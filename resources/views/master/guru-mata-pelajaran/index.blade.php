...
@section('content')
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Penugasan Guru Mata Pelajaran</li>
                </ol>
            </nav>
            <h2 class="h4">Manajemen Penugasan Guru Mata Pelajaran</h2>
        </div>
    ...
    <div class="card shadow border-0 mb-4">
        <div class="card-header">
            <h5 class="mb-0">Daftar Penugasan Guru Mata Pelajaran</h5>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-centered table-nowrap mb-0 rounded" id="assignment-table">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title" id="modalTitle">Tambah Penugasan Guru</h5>
        ...
        $(document).ready(function() {
            ...
            let table = $('#assignment-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'mata_pelajaran.nama_pelajaran',
                        name: 'mata_pelajaran.nama_pelajaran'
                    },
                    {
                        data: 'action',
                        name: 'action',
            ...
            $('#createAssignmentModal').on('hidden.bs.modal', function() {
                ...
                $('#assignment_id').val('');
                $('#modalTitle').text('Tambah Penugasan Guru');
            });
        });
    </script>
@endpush
