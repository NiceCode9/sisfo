        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1>Edit Artikel</h1>
                    <div>
                        <a href="{{ $artikel->url }}" class="btn btn-outline-info" target="_blank">
                            ...
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <small class="text-muted">
                                        ...
                                        <span
                                            class="badge
                                        @if ($artikel->seo_score >= 8) bg-success
                                        @elseif($artikel->seo_score >= 5) bg-warning
                                        @else bg-danger @endif">
                                            {{ $artikel->seo_score }}/10
                                        </span>
                                    </small>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="excerpt" name="excerpt" rows="3" required>{{ old('excerpt', $artikel->excerpt) }}</textarea>
                                        <small class="form-text text-muted">Maksimal 500 karakter</small>
                                    </div>

                                    <div class="mb-3">
                                        <label for="content" class="form-label">Konten *</label>
                                        <textarea class="form-control" id="content" name="content" rows="15" required>{{ old('content', $artikel->content) }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="meta_description" name="meta_description" rows="3">{{ old('meta_description', $artikel->meta_description) }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="text-center">
                                                <h4 class="text-primary">{{ number_format($artikel->views_count) }}</h4>
                                                <small class="text-muted">Views</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="text-center">
                                                <h4 class="text-success">{{ number_format($artikel->likes_count) }}</h4>
                                                <small class="text-muted">Likes</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="text-center">
                                                <h4 class="text-info">{{ number_format($artikel->shares_count) }}</h4>
                                                <small class="text-muted">Shares</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="text-center">
                                                <h4 class="text-warning">{{ number_format($artikel->comments_count) }}</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" name="is_breaking"
                                            value="1" id="is_breaking"
                                            {{ old('is_breaking', $artikel->is_breaking) ? 'checked' : '' }}>
                                    ...
                                    @if ($artikel->published_at)
                                        <div class="mb-3">
                                            ...
                                            <div class="form-control-plaintext">
                                                {{ $artikel->published_at->format('d M Y, H:i') }}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control-plaintext">
                                            {{ number_format($artikel->word_count) }} kata
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="featured_image" class="form-label">
                                            {{ $artikel->featured_image ? 'Ganti Gambar' : 'Upload Gambar' }}
                                        </label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="featured_image_caption" name="featured_image_caption" rows="2">{{ old('featured_image_caption', $artikel->featured_image_caption) }}</textarea>
                                    </div>
                                </div>
                            </div>
