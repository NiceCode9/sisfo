    ...
    <div class="card shadow border-0 mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-centered table-nowrap mb-0 rounded" id="kelas-table">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#createKelasModal').on('hidden.bs.modal', function() {
                $('#kelasForm')[0].reset();
                $('#kelas_id').val('');
