                ...
                @forelse ($articlestops as $item)
                    <article
                        ...
                        <div class="relative overflow-hidden">
                            <img src="{{ $article->featured_image }}" alt="Berita 1"
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach ($ekstrakurikulers as $e)
                    <div
                        ...
                        <img src="{{ $e->foto ? asset('storage/' . $e->foto) : '' }}" alt="{{ $e->nama_ekskul }}"
                            class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div
                        ...
                        <div
                            ...
                            <p class="font-semibold">{{ $e->nama_ekskul }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="md:flex items-center gap-16">
                ...
                <div class="md:w-1/2">
                    ...
                    <h2
                        class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-6">
                        {{ $profileSekolah->nama_sekolah ?? 'SMP Harapan Bangsa' }}
                    </h2>

                    <p class="text-xl text-gray-600 mb-8 leading-relaxed">
                        SMP Harapan Bangsa didirikan pada tahun {{ $profileSekolah->tahun_berdiri ?? '' }} dengan visi
                        {{ $profileSekolah->visi ?? '' }}
                    </p>
                            ...
                            <div
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 leading-relaxed">"{{ $profileSekolah->visi ?? '' }}"</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-3">
                                            @if (!empty($profileSekolah->misi) && is_array($profileSekolah->misi))
                                                @forelse ($profileSekolah->misi as $misi)
                                                    <div class="flex items-start">
                                                        <div
                                                            class="w-2 h-2 bg-gradient-to-r from-green-500 to-teal-500 rounded-full mt-2 mr-3 flex-shrink-0">
                                                        </div>
                                                        <p class="text-gray-600">{{ $misi }}</p>
                                                    </div>
                                                @empty
                                                    <p class="text-gray-400 italic">Belum ada misi yang ditambahkan.</p>
                                                @endforelse
                                            @else
                                                <p class="text-gray-400 italic">Data misi tidak tersedia.</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <h2 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                ...
                <span class="bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">Keluarga
                    Besar</span>
                <br>{{ $profileSekolah->nama_sekolah ?? '' }}?
            </h2>
